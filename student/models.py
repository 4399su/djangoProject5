...
class Question(models.Model):
    ...
    optionA = models.CharField('A选项', max_length=1000)
    optionB = models.CharField('B选项', max_length=1000)
    optionC = models.CharField('C选项', max_length=1000)
    optionD = models.CharField('D选项', max_length=1000)
